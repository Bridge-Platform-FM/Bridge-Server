...
router.post('/auth/mfa/trigger-otp', adminMiddleware, authorize(PERMISSIONS.ADMIN_AUTH.MFA_TRIGGER_OTP), adminController.triggerOtp);

router.post('/auth/mfa/verify-otp', adminMiddleware, authorize(PERMISSIONS.ADMIN_AUTH.MFA_VERIFY_OTP), adminController.verifyMfaOtp);

router.post('auth/mfa/resend-otp', adminMiddleware, authorize(PERMISSIONS.ADMIN_AUTH.MFA_RESEND_OTP), adminController.resendMfaOtp);
