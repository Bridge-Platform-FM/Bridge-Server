...
router.post('/mfa/trigger-otp', authMiddleware, authorize(PERMISSIONS.AUTH.MFA_TRIGGER_OTP), authController.triggerOtp);

router.post('/mfa/verify-otp', authMiddleware, authorize(PERMISSIONS.AUTH.MFA_VERIFY_OTP), authController.verifyMfaOtp);

router.post('/mfa/resend-otp', authMiddleware, authorize(PERMISSIONS.AUTH.MFA_RESEND_OTP), authController.resendMfaOtp);
