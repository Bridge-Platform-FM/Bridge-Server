...
const verifyOtp = async (channel, identifier, otp) => {
    try {
        ...
        return ServiceResponse.error({
            message: err.message || 'Error encountered while verifying OTP.',
            data: []
        });
    }
};
...
const handleFailedAttempt = async (record, isEmailChannel) => {
    try {
        ...
        return ServiceResponse.error({
            message: error.message || 'Error encountered while processing failed OTP attempt.',
            data: []
        });
    }
};
...
const resendOtp = async (channel, identifier) => {
    try {
        ...
        return ServiceResponse.error({
            message: error.message || 'Error encountered while resending OTP.',
            data: []
        });
