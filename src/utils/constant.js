...
// Distinct resend-throttle buckets per flow. Each purpose+channel gets its own
// independent resend allowance (see otp.service.sendOTP).
const OTP_PURPOSE = {
...
module.exports = { OTP_MESSAGES, REGISTRATION_MESSAGES, AUTH_MESSAGES, ROLE_FIELD_METADATA_MESSAGES, 
    ...
    KYC_STATUS, CHANNEL_TYPE, OTP_PURPOSE, LOGIN_MESSAGES, REDIRECT_ROUTES, ADMIN_MESSAGES,
